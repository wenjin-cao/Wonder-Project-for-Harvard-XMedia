...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006c18e49100000000377f7ad3(
...
class phpbbtemplatetwiglexer_000000006c18e49100000000377f7ad3 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a34a8442781b058547230 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a34a84427825844943588 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a34a84427803841593883 = array(
    ...
    {
        $this->initializer5a34a84427825844943588 && $this->initializer5a34a84427825844943588->__invoke($this->valueHolder5a34a8442781b058547230, $this, 'set_environment', array('env' => $env), $this->initializer5a34a84427825844943588);

        return $this->valueHolder5a34a8442781b058547230->set_environment($env);
    }
    ...
    {
        $this->initializer5a34a84427825844943588 && $this->initializer5a34a84427825844943588->__invoke($this->valueHolder5a34a8442781b058547230, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a34a84427825844943588);

        return $this->valueHolder5a34a8442781b058547230->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a34a84427825844943588 && $this->initializer5a34a84427825844943588->__invoke($this->valueHolder5a34a8442781b058547230, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a34a84427825844943588);

        return $this->valueHolder5a34a8442781b058547230->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a34a84427825844943588 = $initializer;
    }
    ...
    {
        $this->initializer5a34a84427825844943588 && $this->initializer5a34a84427825844943588->__invoke($this->valueHolder5a34a8442781b058547230, $this, '__get', array('name' => $name), $this->initializer5a34a84427825844943588);

        if (isset(self::$publicProperties5a34a84427803841593883[$name])) {
            return $this->valueHolder5a34a8442781b058547230->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a34a8442781b058547230;
    ...
    {
        $this->initializer5a34a84427825844943588 && $this->initializer5a34a84427825844943588->__invoke($this->valueHolder5a34a8442781b058547230, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a34a84427825844943588);
    ...
    {
        $this->initializer5a34a84427825844943588 && $this->initializer5a34a84427825844943588->__invoke($this->valueHolder5a34a8442781b058547230, $this, '__isset', array('name' => $name), $this->initializer5a34a84427825844943588);
    ...
    {
        $this->initializer5a34a84427825844943588 && $this->initializer5a34a84427825844943588->__invoke($this->valueHolder5a34a8442781b058547230, $this, '__unset', array('name' => $name), $this->initializer5a34a84427825844943588);
    ...
    {
        $this->initializer5a34a84427825844943588 && $this->initializer5a34a84427825844943588->__invoke($this->valueHolder5a34a8442781b058547230, $this, '__clone', array(), $this->initializer5a34a84427825844943588);

        $this->valueHolder5a34a8442781b058547230 = clone $this->valueHolder5a34a8442781b058547230;
    }

    public function __sleep()
    {
        $this->initializer5a34a84427825844943588 && $this->initializer5a34a84427825844943588->__invoke($this->valueHolder5a34a8442781b058547230, $this, '__sleep', array(), $this->initializer5a34a84427825844943588);

        return array('valueHolder5a34a8442781b058547230');
    }
    ...
    {
        return $this->initializer5a34a84427825844943588;
    }
    ...
    {
        return $this->initializer5a34a84427825844943588 && $this->initializer5a34a84427825844943588->__invoke($this->valueHolder5a34a8442781b058547230, $this, 'initializeProxy', array(), $this->initializer5a34a84427825844943588);
    }
    ...
    {
        return null !== $this->valueHolder5a34a8442781b058547230;
    }
    ...
    {
        return $this->valueHolder5a34a8442781b058547230;
    }
