...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sitesplat.bbcore.helper' => 'getSitesplat_Bbcore_HelperService',
    ...
    {
        return $this->services['sitesplat.bbcore.admin_listener'] = new \sitesplat\BBCore\event\admin_listener($this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('template'), $this->get('ext.manager'), $this->get('cache'), $this->get('file_downloader'), './../');
    }

    /**
     * Gets the 'sitesplat.bbcore.helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \sitesplat\BBCore\helper A sitesplat\BBCore\helper instance
     */
    protected function getSitesplat_Bbcore_HelperService()
    {
        return $this->services['sitesplat.bbcore.helper'] = new \sitesplat\BBCore\helper($this->get('dbal.conn'), $this->get('config'), $this->get('ext.manager'), $this->get('template'), $this->get('user'), $this->get('request'), $this->get('log'), $this->get('cache'), './../');
    }
    ...
    {
        return $this->services['sitesplat.bbcore.listener'] = new \sitesplat\BBCore\event\listener($this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('controller.helper'), $this->get('template'), $this, './../', 'php', $this->get('path_helper'));
    }
    ...
    {
        return $this->services['sitesplat.flatbootsminicms.listener'] = new \sitesplat\flatbootsminicms\event\listener($this->get('dbal.conn'), $this->get('config'), $this->get('template'), $this->get('user'), './../', 'php', 'phpbb_flatboots_style_menu', 'phpbb_flatboots_style_config', 'phpbb_flatboots_style_links', 'phpbb_flatboots_style_social');
    }
    ...
    {
        return $this->services['sitesplat.fltl.main'] = new \sitesplat\fltl\controller\main($this->get('dbal.conn'), $this->get('auth'), $this->get('config'), $this->get('user'), $this->get('request'), $this->get('dispatcher'), './../', 'php');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000003fb594a000000004111fc6f(
...
class phpbbtemplatetwiglexer_0000000003fb594a000000004111fc6f extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a34a97b487b4431599537 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a34a97b487be740478487 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a34a97b4879a939664527 = array(
    ...
    {
        $this->initializer5a34a97b487be740478487 && $this->initializer5a34a97b487be740478487->__invoke($this->valueHolder5a34a97b487b4431599537, $this, 'set_environment', array('env' => $env), $this->initializer5a34a97b487be740478487);

        return $this->valueHolder5a34a97b487b4431599537->set_environment($env);
    }
    ...
    {
        $this->initializer5a34a97b487be740478487 && $this->initializer5a34a97b487be740478487->__invoke($this->valueHolder5a34a97b487b4431599537, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a34a97b487be740478487);

        return $this->valueHolder5a34a97b487b4431599537->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a34a97b487be740478487 && $this->initializer5a34a97b487be740478487->__invoke($this->valueHolder5a34a97b487b4431599537, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a34a97b487be740478487);

        return $this->valueHolder5a34a97b487b4431599537->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a34a97b487be740478487 = $initializer;
    }
    ...
    {
        $this->initializer5a34a97b487be740478487 && $this->initializer5a34a97b487be740478487->__invoke($this->valueHolder5a34a97b487b4431599537, $this, '__get', array('name' => $name), $this->initializer5a34a97b487be740478487);

        if (isset(self::$publicProperties5a34a97b4879a939664527[$name])) {
            return $this->valueHolder5a34a97b487b4431599537->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a34a97b487b4431599537;
    ...
    {
        $this->initializer5a34a97b487be740478487 && $this->initializer5a34a97b487be740478487->__invoke($this->valueHolder5a34a97b487b4431599537, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a34a97b487be740478487);
    ...
    {
        $this->initializer5a34a97b487be740478487 && $this->initializer5a34a97b487be740478487->__invoke($this->valueHolder5a34a97b487b4431599537, $this, '__isset', array('name' => $name), $this->initializer5a34a97b487be740478487);
    ...
    {
        $this->initializer5a34a97b487be740478487 && $this->initializer5a34a97b487be740478487->__invoke($this->valueHolder5a34a97b487b4431599537, $this, '__unset', array('name' => $name), $this->initializer5a34a97b487be740478487);
    ...
    {
        $this->initializer5a34a97b487be740478487 && $this->initializer5a34a97b487be740478487->__invoke($this->valueHolder5a34a97b487b4431599537, $this, '__clone', array(), $this->initializer5a34a97b487be740478487);

        $this->valueHolder5a34a97b487b4431599537 = clone $this->valueHolder5a34a97b487b4431599537;
    }

    public function __sleep()
    {
        $this->initializer5a34a97b487be740478487 && $this->initializer5a34a97b487be740478487->__invoke($this->valueHolder5a34a97b487b4431599537, $this, '__sleep', array(), $this->initializer5a34a97b487be740478487);

        return array('valueHolder5a34a97b487b4431599537');
    }
    ...
    {
        return $this->initializer5a34a97b487be740478487;
    }
    ...
    {
        return $this->initializer5a34a97b487be740478487 && $this->initializer5a34a97b487be740478487->__invoke($this->valueHolder5a34a97b487b4431599537, $this, 'initializeProxy', array(), $this->initializer5a34a97b487be740478487);
    }
    ...
    {
        return null !== $this->valueHolder5a34a97b487b4431599537;
    }
    ...
    {
        return $this->valueHolder5a34a97b487b4431599537;
    }
