...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000414175ac0000000071a305a4(
...
class phpbbtemplatetwiglexer_00000000414175ac0000000071a305a4 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a34a9659d573807134343 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a34a9659d57f222014833 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a34a9659d54d557557457 = array(
    ...
    {
        $this->initializer5a34a9659d57f222014833 && $this->initializer5a34a9659d57f222014833->__invoke($this->valueHolder5a34a9659d573807134343, $this, 'set_environment', array('env' => $env), $this->initializer5a34a9659d57f222014833);

        return $this->valueHolder5a34a9659d573807134343->set_environment($env);
    }
    ...
    {
        $this->initializer5a34a9659d57f222014833 && $this->initializer5a34a9659d57f222014833->__invoke($this->valueHolder5a34a9659d573807134343, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a34a9659d57f222014833);

        return $this->valueHolder5a34a9659d573807134343->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a34a9659d57f222014833 && $this->initializer5a34a9659d57f222014833->__invoke($this->valueHolder5a34a9659d573807134343, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a34a9659d57f222014833);

        return $this->valueHolder5a34a9659d573807134343->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a34a9659d57f222014833 = $initializer;
    }
    ...
    {
        $this->initializer5a34a9659d57f222014833 && $this->initializer5a34a9659d57f222014833->__invoke($this->valueHolder5a34a9659d573807134343, $this, '__get', array('name' => $name), $this->initializer5a34a9659d57f222014833);

        if (isset(self::$publicProperties5a34a9659d54d557557457[$name])) {
            return $this->valueHolder5a34a9659d573807134343->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a34a9659d573807134343;
    ...
    {
        $this->initializer5a34a9659d57f222014833 && $this->initializer5a34a9659d57f222014833->__invoke($this->valueHolder5a34a9659d573807134343, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a34a9659d57f222014833);
    ...
    {
        $this->initializer5a34a9659d57f222014833 && $this->initializer5a34a9659d57f222014833->__invoke($this->valueHolder5a34a9659d573807134343, $this, '__isset', array('name' => $name), $this->initializer5a34a9659d57f222014833);
    ...
    {
        $this->initializer5a34a9659d57f222014833 && $this->initializer5a34a9659d57f222014833->__invoke($this->valueHolder5a34a9659d573807134343, $this, '__unset', array('name' => $name), $this->initializer5a34a9659d57f222014833);
    ...
    {
        $this->initializer5a34a9659d57f222014833 && $this->initializer5a34a9659d57f222014833->__invoke($this->valueHolder5a34a9659d573807134343, $this, '__clone', array(), $this->initializer5a34a9659d57f222014833);

        $this->valueHolder5a34a9659d573807134343 = clone $this->valueHolder5a34a9659d573807134343;
    }

    public function __sleep()
    {
        $this->initializer5a34a9659d57f222014833 && $this->initializer5a34a9659d57f222014833->__invoke($this->valueHolder5a34a9659d573807134343, $this, '__sleep', array(), $this->initializer5a34a9659d57f222014833);

        return array('valueHolder5a34a9659d573807134343');
    }
    ...
    {
        return $this->initializer5a34a9659d57f222014833;
    }
    ...
    {
        return $this->initializer5a34a9659d57f222014833 && $this->initializer5a34a9659d57f222014833->__invoke($this->valueHolder5a34a9659d573807134343, $this, 'initializeProxy', array(), $this->initializer5a34a9659d57f222014833);
    }
    ...
    {
        return null !== $this->valueHolder5a34a9659d573807134343;
    }
    ...
    {
        return $this->valueHolder5a34a9659d573807134343;
    }
