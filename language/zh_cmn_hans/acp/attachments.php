...
$lang = array_merge($lang, array(
	...
	'ACP_ORPHAN_ATTACHMENTS_EXPLAIN'	=> '这里您可以看见附件上传目录中存在但是没有发表在帖子中的文件。这很可能因为用户添加了附件但是最后没提交帖子。您可以删除这些附件或者将其添加到已有的帖子中。添加附件到帖子中需要一个有效的帖子ID，您需要自己添加这个ID，这个功能主要是帮助那些希望通过其他方式上传文件的人们，可以把附件(通常会很大)添加到已经发表的帖子中。',
	'ADD_EXTENSION'						=> '添加扩展名',
	...
	'FILES_GONE'			=> '一些您要删除的附件不存在，它们可能已被删除，存在的附件被删除。',
	'FILES_STATS_WRONG'		=> '您的文件数据好像不准确需要重新同步，实际值：附件数量 = %1$d，附件总大小 = %2$s。<br />点%3$s这里%4$s重新同步它们。',
